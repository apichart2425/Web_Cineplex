            ...
            <div class="tab-pane fade in show active" id="panel1" role="tabpanel">
              ...
              <div class="modal-body mb-1">
                <div class="md-form form-sm mb-5">
                  ...
                  <input v-model="email" type="email" id="modalLRInput1" class="form-control" required="">
                  <a style="color: red">{{errorEmail}}</a>
                </div>

                <div class="md-form form-sm mb-4">
                  <label data-error="wrong" data-success="right" for="modalLRInput2">รหัสผ่าน</label>
                  <input v-model="password" type="password" id="modalLRInput2" class="form-control" required="">
                  <a style="color: red">{{errorPassword}}</a>
                </div>
                <div class="text-center mt-2">
                  <button class="btn btn-info " @click="checkFormLogin" data-target="#myModal">เข้าสู่ระบบ</button>
                </div>
              </div>
              <!--Footer-->
              <div class="modal-footer">
                <div class="options text-center text-md-right mt-1">
                  <p>เป็นสมาชิกหรือไม่? <a href="#panel2" class="blue-text" >สมัครสมาชิก</a></p>
            ...
            <div class="tab-pane fade" id="panel2" role="tabpanel">
              ...
              <div class="modal-body">
                <div class="md-form form-sm mb-5">
                  ...
                  <input type="email" id="modalLRInput3" v-model = "email" class="form-control" required="">
                  <a style="color: red">{{errorEmail}}</a>
                </div>

                <div class="md-form form-sm mb-5">
                  <label data-error="wrong" data-success="right" for="modalLRInput4">รหัสผ่าน</label>
                  <input type="password" id="modalLRInput4" v-model = "password" class="form-control" required="">
                  <a style="color: red">{{errorPassword}}</a>
                </div>

                <div class="md-form form-sm mb-4">
                  <label data-error="wrong" data-success="right" for="modalLRInput5">ยืนยันรหัสผ่าน</label>
                  <input type="password" id="modalLRInput5"  v-model = "repass" class="form-control" required="">
